            ...
            <div className="col-md-4 text-center animate-box">
                <div className="services color-1">
                    ...
                    <div className="desc">
                        ...
                        <a href="https://dzone.com/articles/tutorial-how-to-build-a-pwa-with-face-and-speechrecognition" rel="noopener noreferrer" target="_blank" class="btn btn-primary">Check It Out</a>
                    </div>
                </div>
            </div>  
            <div className="col-md-4 text-center animate-box">
                <div className="services color-3">
                    ...
                    <div className="desc">
                        <h3>Hooks by Example: Convert a Tesla Battery Range Calculator to Functional Components with React Hooks (October 2020)</h3>
                        ...
                        <a href="https://dzone.com/articles/steps-to-convert-the-react-tesla-battery-range-calc-to-func-comp-with-hooks" rel="noopener noreferrer" target="_blank" class="btn btn-primary">Check It Out</a>
                    </div>
                </div>
            </div>
            <div className="col-md-4 text-center animate-box">
                <div className="services color-2">
                    ...
                    <div className="desc">
                        ...
                        <a href="https://dzone.com/articles/how-to-build-a-progressive-selfies-web-app" rel="noopener noreferrer" target="_blank" class="btn btn-primary">Check It Out</a>
                    </div>
                </div>
            </div>
            <div className="col-md-4 text-center animate-box">
                <div className="services color-3">
                    ...
                    <div className="desc">
                        ...
                        <a href="https://dzone.com/articles/how-to-build-a-progressive-web-app-pwa-with-javasc" rel="noopener noreferrer" target="_blank" class="btn btn-primary">Check It Out</a>
                    </div>
                </div>
            </div>
            <div className="col-md-4 text-center animate-box">
                <div className="services color-3">
                    ...
                    <div className="desc">
                        <h3>Vue.js Tutorial: Build a Tesla Battery Range Calculator (September 2019)</h3>
                        <p>In this tutorial, we get started with Vue.js, an easy-to-understand JavaScript framework.
                        </p>
                        <a href="https://dzone.com/articles/build-a-tesla-battery-range-calculator-yourself-it" rel="noopener noreferrer" target="_blank" class="btn btn-primary">Check It Out</a>
                    </div>
                </div>
            </div>
            <div className="col-md-4 text-center animate-box">
                <div className="services color-1">
                    ...
                    <div className="desc">
                        ...
                        <a href="https://dzone.com/articles/building-mobile-apps-with-angular-and-nativescript" rel="noopener noreferrer"target="_blank" class="btn btn-primary">Check It Out</a>
                    </div>
                </div>
            </div>
            <div className="col-md-4 text-center animate-box">
                <div className="services color-3">
                    ...
                    <div className="desc">
                        ...
                        <a href="https://dzone.com/articles/microservices-yes-but-no-spaghetti-please" rel="noopener noreferrer"target="_blank" class="btn btn-primary">Check It Out</a>
                    </div>
                </div>
            </div>
            <div className="col-md-4 text-center animate-box">
                <div className="services color-1">
                    ...
                    <div className="desc">
                        ...
                        <a href="https://dzone.com/articles/create-your-own-yeoman" rel="noopener noreferrer"target="_blank" class="btn btn-primary">Check It Out</a>
                    </div>
                </div>
            </div>
