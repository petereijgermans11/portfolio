            ...
            <div className="col-md-4 text-center animate-box">
                <div className="services color-3">
                    ...
                    <div className="desc">
                        ...
                        <a href="https://www.youtube.com/watch?v=JtNis5Nphro" el="noopener noreferrer" target="_blank" class="btn btn-primary">Check It Out</a>
                    </div>
                </div>
            </div>
            ...
            <div className="col-md-4 text-center animate-box">
                <div className="services color-1">
                    ...
                    <div className="desc">
                        ...
                        <a href="https://www.youtube.com/watch?v=aITJrCBLUNA" el="noopener noreferrer" target="_blank" class="btn btn-primary">Check It Out</a>
                    </div>
                </div>
            </div>
            ...
            <div className="col-md-4 text-center animate-box">
                <div className="services color-2">
                    ...
                    <div className="desc">
                        ...
                        <a href="https://www.youtube.com/watch?v=Z7-SAmtMwZQ" el="noopener noreferrer" target="_blank" class="btn btn-primary">Check It Out</a>
                    </div>
                </div>
            </div>
            <div className="col-md-4 text-center animate-box">
                <div className="services color-3">
                    ...
                    <div className="desc">
                        ...
                        <a href="https://www.youtube.com/watch?v=sP7dtZm_Wx0" el="noopener noreferrer" target="_blank" class="btn btn-primary">Check It Out</a>
                    </div>
                </div>
            </div>
            <div className="col-md-4 text-center animate-box">
                <div className="services color-1">
                    ...
                    <div className="desc">
                        ...
                        <a href="https://www.youtube.com/watch?v=8IOn81cRMZI&feature=youtu.be" el="noopener noreferrer" target="_blank" class="btn btn-primary">Check It Out</a>
                    </div>
                </div>
            </div>
            <div className="col-md-4 text-center animate-box">
                <div className="services color-3">
                    ...
                    <div className="desc">
                        ...
                        <a href="https://www.slideshare.net/secret/IKGzzgMMEsSdH8" el="noopener noreferrer" target="_blank" class="btn btn-primary">Check It Out</a>
            ...
            <div className="col-md-4 text-center animate-box">
                <div className="services color-1">
                    ...
                    <div className="desc">
                        ...
                        <a href="https://www.slideshare.net/secret/44kcAPk607XegA" el="noopener noreferrer" target="_blank" class="btn btn-primary">Check It Out</a>
                    </div>
                </div>
            </div>
            <div className="col-md-4 text-center animate-box">
                <div className="services color-1">
                    ...
                    <div className="desc">
                        ...
                        <a href="https://www.youtube.com/watch?v=EkEADLsJmcM&list=PLt4L3V8wVnF5ph1PP6h7qFfH6DI8xWlpJ&index=22&t=0s" el="noopener noreferrer" target="_blank" class="btn btn-primary">Check It Out</a>
                    </div>
                </div>
            </div>
            <div className="col-md-4 text-center animate-box">
            ...
            <div className="col-md-4 text-center animate-box">
                <div className="services color-1">
                    ...
                    <div className="desc">
                        ...
                        <a href="https://www.youtube.com/watch?v=vkgDlh4kZfg" el="noopener noreferrer" target="_blank" class="btn btn-primary">Check It Out</a>
                    </div>
                </div>
            </div>
            <div className="col-md-4 text-center animate-box">
                <div className="services color-1">
                    ...
                    <div className="desc">
                        ...
                        <a href="https://www.youtube.com/watch?v=GIWKX9J7HXA" el="noopener noreferrer" target="_blank" class="btn btn-primary">Check It Out</a>
                    </div>
                </div>
            </div>
            <div className="col-md-4 text-center animate-box">
                <div className="services color-3">
                    ...
                    <div className="desc">
                        ...
                        <a href="https://www.slideshare.net/slideshow/embed_code/key/t4V7uKe7udR1hW" el="noopener noreferrer" target="_blank" class="btn btn-primary">Check It Out</a>
                    </div>
                </div>
            </div>
            <div className="col-md-4 text-center animate-box">
                <div className="services color-1">
                    ...
                    <div className="desc">
                        ...
                        <a href="https://www.youtube.com/watch?v=HyvC0t2jH1g" tel="noopener noreferrer" arget="_blank" class="btn btn-primary">Check It Out</a>
                    </div>
                </div>
            </div>
            <div className="col-md-4 text-center animate-box">
                <div className="services color-1">
                    ...
                    <div className="desc">
                        ...
                        <a href="https://www.youtube.com/watch?v=4RILEdh3PUo" el="noopener noreferrer" target="_blank" class="btn btn-primary">Check It Out</a>
                    </div>
                </div>
            </div>
            </div>
