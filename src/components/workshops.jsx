            ...
            <div className="col-md-4 text-center animate-box">
                <div className="services color-3">
                    ...
                    <div className="desc">
                        ...
                        <a href="https://github.com/petereijgermans11/workshop-reactjs-vuejs" rel="noopener noreferrer"target="_blank" class="btn btn-primary">Check It Out</a>
                    </div>
                </div>
            </div>
            <div className="col-md-4 text-center animate-box">
                <div className="services color-3">
                    ...
                    <div className="desc">
                        ...
                        <a href="https://github.com/petereijgermans11/workshop-angular10" rel="noopener noreferrer"target="_blank" class="btn btn-primary">Check It Out</a>
                    </div>
                </div>
            </div>
            <div className="col-md-4 text-center animate-box">
                <div className="services color-3">
                    ...
                    <div className="desc">
                        ...
                        <a href="https://github.com/petereijgermans11/progressive-web-app/" rel="noopener noreferrer"target="_blank" class="btn btn-primary">Check It Out</a>
                    </div>
                </div>
            </div>
            <div className="col-md-4 text-center animate-box">
            ...
            <div className="col-md-4 text-center animate-box">
                <div className="services color-1">
                    ...
                    <div className="desc">
                        ...
                        <a href="https://github.com/petereijgermans11/workshop-graphql" rel="noopener noreferrer"target="_blank" class="btn btn-primary">Check It Out</a>
                    </div>
                </div>
            </div>
            <div className="col-md-4 text-center animate-box">
                <div className="services color-1">
                    ...
                    <div className="desc">
                        ...
                        <a href="https://github.com/petereijgermans11/accelerator-programma" rel="noopener noreferrer"target="_blank" class="btn btn-primary">Check It Out</a>
                    </div>
                </div>
            </div>
            <div className="col-md-4 text-center animate-box">
